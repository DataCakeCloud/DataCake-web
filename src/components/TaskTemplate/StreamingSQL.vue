  ...
  <div class="step2" :class="source === 'task' ? 'taskStep2' : ''">
    ...
    <div class="step-content">
      <div v-show="currentStep === 1">
        <el-form ref="form" class="inline-form" :inline="true" :model="form" :rules="dataRules" label-width="82px">
          <el-form-item :label="$t('task.region')" prop="region">
            ...
            <el-select v-model="form.region" class="area-select" :placeholder="$t('task.dbTip2')" clearable @change="changeRegion">
      ...
      <el-drawer title="高级设置" :visible.sync="drawerVisible" :append-to-body="true" :with-header="false" direction="rtl" :size="500" :before-close="handleClose">
        <!--  :is-show-model="true" -->
        <senior-sql-form ref="seniorFormSql" :no-cluster="noCluster" :senior-form="seniorFormSql" :is-show-batch="true" :region="form.region" @close="drawerVisible = false"></senior-sql-form>
      </el-drawer>
    </div>
    <div class="btn-wrap">
