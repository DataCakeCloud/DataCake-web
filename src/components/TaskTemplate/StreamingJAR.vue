...
<template>
  <div class="step2" :class="source === 'task' ? 'taskStep2' : ''">
    ...
    <div class="step-content">
      ...
      <step-three v-if="currentStep === 2" ref="stepThree" :is-show-dispatch="seniorForm.isBatchTask" :is-show-input-btn="true" :is-show-output-btn="true" :is-input-edit="true" :is-output-edit="true" :is-jar="true" :is-show-offset="false" :rule-form="ruleForm"></step-three>
