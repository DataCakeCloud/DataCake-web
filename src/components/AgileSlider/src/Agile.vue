<template>
  <div :class="{ 'agile--ssr': isSSR, 'agile--auto-play': settings.autoplay, 'agile--disabled': settings.unagile, 'agile--fade': settings.fade && !settings.unagile, 'agile--rtl': settings.rtl, 'agile--no-nav-buttons': !settings.navButtons }" class="agile" @touchstart="() => {}">
    <div ref="list" class="agile__list">
      <div ref="track" :style="{ transform: `translate(${translateX + marginX}px)`, transition: `transform ${settings.timing} ${transitionDelay}ms` }" class="agile__track" @mouseout="handleMouseOut('track')" @mouseover="handleMouseOver('track')">
