  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { cnName: 'Flink Jar模板', title: 'flinkJarTemplate', isTaskTemplate: true },
        hidden: true
      },
      {
        path: 'step2FlinkSQL',
        ...
        meta: { cnName: 'Flink SQL模板', title: 'flinkSqlTemplate', isTaskTemplate: true },
        hidden: true
      },
      {
        path: 'step2Metis',
        ...
        meta: { cnName: 'Metis->Iceberg模板', title: 'metisTemplate', isTaskTemplate: true },
        hidden: true
      },
      {
        path: 'step2CDC',
        ...
        meta: { cnName: 'CDC->Iceberg模板', title: 'step2CDCTemplate', isTaskTemplate: true },
        hidden: true
      },
      {
        path: 'step2Kafka',
        ...
        meta: { cnName: 'Kafka->ClickHouse模板', title: 'kafkaTemplate', isTaskTemplate: true },
        hidden: true
      },
      {
        path: 'step2HiveSQL',
        ...
        meta: { cnName: 'Hive->Hive SQL模板', title: 'hiveSqlTemplate', isTaskTemplate: true },
        hidden: true
      },
      {
        path: 'step2Hive',
        ...
        meta: { cnName: 'MySql->Lakehouse模板', title: 'lakehouseTemplate', isTaskTemplate: true },
        hidden: true
      },
      {
        path: 'step2File',
        ...
        meta: { cnName: 'COS->Lakehouse模板', title: 'step2FileTemplate', isTaskTemplate: true },
        hidden: true
      },
      {
        path: 'step2SparkJar',
        ...
        meta: { cnName: 'Spark Jar模板', title: 'sparkJarTemplate', isTaskTemplate: true },
        hidden: true
      },
      {
        path: 'step2Shell',
        ...
        meta: { cnName: 'Shell/Python脚本 模板', title: 'pythonOrshellTemplate', isTaskTemplate: true },
        hidden: true
      },
      {
        path: 'step2Doris',
        ...
        meta: { cnName: 'Hive->Doris模板', title: 'dorisTemplate', isTaskTemplate: true },
        hidden: true
      },
      {
        path: 'step2MySql',
        ...
        meta: { cnName: 'Hive->MySql模板', title: 'hive2MysqlTemplate', isTaskTemplate: true },
        hidden: true
      },
      {
        path: 'step2Hive2File',
        ...
        meta: { cnName: 'Hive->File模板', title: 'hive2FileTemplate', isTaskTemplate: true },
        hidden: true
      },
      {
        path: 'artifact',
