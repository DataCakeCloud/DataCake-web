...
const service = axios.create({
  baseURL: process.env.NODE_ENV === 'development' || process.env.NODE_ENV === 'cloud-aws-development' ? process.env.VUE_APP_BASE_API2 : process.env.VUE_APP_API_PATH2, // url = base url + request url
