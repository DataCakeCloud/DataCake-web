...
const service = axios.create({
  baseURL: process.env.NODE_ENV === 'development' || process.env.NODE_ENV === 'cloud-aws-development' ? process.env.VUE_APP_BASE_API3 : process.env.VUE_APP_API_PATH3, // url = base url + request url
