...
export function getEngineList(data) {
  return axios.post('/ds_task/engine/getEngineList', data);
}
...
export function getLocationUrl(params) {
  return axios.get('/ds_task/task/getLocation', { params });
}
export function getName(params) {
  return axios.get('/ds_task/actor/sources/get', { params });
}
// 获取sql
export function getCreateTableSql(params) {
  return axios.post(`/ds_task/task/getCreateTableSql?region=${params.region}&owner=${params.owner}`, params.catalog);
}
export function getChangeTableSql(params) {
  return axios.post(`/ds_task/task/changeSchemaColumn?region=${params.region}&owner=${params.owner}`, params.catalog);
}
// 执行sql
export function doTableSql(params) {
  return axios.post('/ds_task/metadata/createTable', params);
}
export function doHiveTableSql(params) {
  return axios.post('/ds_task/task/executeSql', params);
}
export function getTypeMapListFn(params) {
  return axios.get('/ds_task/task/getTypeMaping', { params });
}
