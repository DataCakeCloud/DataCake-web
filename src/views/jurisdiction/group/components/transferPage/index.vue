  ...
  <div class="transfer">
    <div class="leftTransfer">
      ...
      <el-checkbox-group v-model="left.transferDataChecked" class="transfer_group" @change="leftHandleCheckedCitiesChange">
        <el-checkbox v-for="item in left.transferData" :key="item[defaultProps.id]" :label="item">{{ formatDataView(item[defaultProps.label]) }}</el-checkbox>
      </el-checkbox-group>
    ...
    <div class="rightTransfer">
      ...
      <el-checkbox-group v-model="right.transferDataChecked" class="transfer_group transfer_group_right" @change="rightHandleCheckedCitiesChange">
        <el-checkbox v-for="item in right.transferData" :key="item[defaultProps.id]" :label="item">{{ formatDataView(item[defaultProps.label]) }}</el-checkbox>
      </el-checkbox-group>
    </div>
  </div>
</template>
