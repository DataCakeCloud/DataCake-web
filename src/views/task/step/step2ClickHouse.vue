<template>
  <el-card class="box-card-container">
    <Hive2Clickhouse ref="step2Ref" :data="data" :is-show-publish="true" @cancel="cancel" @save="save"></Hive2Clickhouse>
  </el-card>
</template>
<script>
import Hive2Clickhouse from '@/components/TaskTemplate/Hive2Clickhouse';
