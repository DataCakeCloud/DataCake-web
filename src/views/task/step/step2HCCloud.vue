<template>
  <el-card class="box-card-container">
    <DataMigration ref="step2Ref" :data="data" :is-show-publish="true" @cancel="cancel" @save="save"></DataMigration>
  </el-card>
</template>
<script>
import DataMigration from '@/components/TaskTemplate/DataMigration';
