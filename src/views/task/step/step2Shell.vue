<template>
  <el-card class="box-card-container">
    <PythonShell ref="step2Ref" :data="data" :is-show-publish="true" @cancel="cancel" @save="save"></PythonShell>
  </el-card>
</template>
<script>
import PythonShell from '@/components/TaskTemplate/PythonShell';
