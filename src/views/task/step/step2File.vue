<template>
  <el-card class="box-card-container">
    <File2Lakehouse ref="step2Ref" :data="data" :is-show-publish="true" @cancel="cancel" @save="save"></File2Lakehouse>
  </el-card>
</template>
<script>
import File2Lakehouse from '@/components/TaskTemplate/File2Lakehouse';
