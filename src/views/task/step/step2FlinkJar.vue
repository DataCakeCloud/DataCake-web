<template>
  <el-card class="box-card-container">
    <StreamingJAR ref="step2Ref" :data="data" :is-show-publish="true" @cancel="cancel" @save="save"></StreamingJAR>
  </el-card>
</template>
<script>
import StreamingJAR from '@/components/TaskTemplate/StreamingJAR';
