<template>
  <el-card class="box-card-container">
    <Step2TrainingModel ref="step2Ref" :data="data" :is-show-publish="true" @cancel="cancel" @save="save"></Step2TrainingModel>
  </el-card>
</template>
<script>
import Step2TrainingModel from '@/components/TaskTemplate/Step2TrainingModel';
