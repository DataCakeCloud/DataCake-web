<template>
  <el-card class="box-card-container">
    <Hive2Redshift ref="step2Ref" :data="data" :is-show-publish="true" @cancel="cancel" @save="save"></Hive2Redshift>
  </el-card>
</template>
<script>
import Hive2Redshift from '@/components/TaskTemplate/Hive2Redshift';
