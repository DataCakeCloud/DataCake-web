<template>
  <el-card class="box-card-container">
    <Hive2Sharestore ref="step2Ref" :data="data" :is-show-publish="true" @cancel="cancel" @save="save"></Hive2Sharestore>
  </el-card>
</template>
<script>
import Hive2Sharestore from '@/components/TaskTemplate/Hive2Sharestore';
