  ...
  <div class="detial">
    <el-tabs v-model="activeName">
      ...
      <el-tab-pane label="表血缘" name="tableRecourse">
        <TableRecourse ref="tableRecourse" />
      </el-tab-pane>
      <el-tab-pane label="字段血缘" name="columnRecourse">
        <ColumnRecourse ref="columnRecourse" :colums="colums" />
      </el-tab-pane>
    </el-tabs>
    <div class="refresh">
...
export default {
  ...
  watch: {
    activeName(val) {
      if (val === 'tableRecourse') {
        this.$refs.tableRecourse?.refresh();
      } else if (val === 'columnRecourse') {
        this.$refs.columnRecourse?.refresh();
      }
    }
  },
  created() {
  ...
  methods: {
    handelRefresh() {
      ...
      this.$refs.tableRecourse?.getLineageGraph();
      this.$refs.columnRecourse?.getLineageGraph();
    },
    setColums(data) {
      this.colums = data;
    },
