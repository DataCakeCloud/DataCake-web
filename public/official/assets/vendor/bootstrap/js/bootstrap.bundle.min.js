...
!(function (t, e) {
  ...
  class hi extends z {
    ...
    _getPopperConfig() {
      ...
      return (
        (this._inNavbar || 'static' === this._config.display) && (B.setDataAttribute(this._menu, 'popper', 'static'), (t.modifiers = [{ name: 'applyStyles', enabled: !1 }])), { ...t, ...('function' == typeof this._config.popperConfig ? this._config.popperConfig(t) : this._config.popperConfig) }
      );
    }
  ...
  class cn extends z {
    ...
    show() {
      ...
      if (
        (this._element.ownerDocument.documentElement.contains(this.tip) || (n.append(i), P.trigger(this._element, this.constructor.eventName('inserted'))), this._popper ? this._popper.update() : (this._popper = this._createPopper(i)), i.classList.add(tn), 'ontouchstart' in document.documentElement)
      )
