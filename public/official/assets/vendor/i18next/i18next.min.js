!(function (e, t) {
  ...
  var S = 'undefined' != typeof window && window.navigator && void 0 === window.navigator.userAgentData && window.navigator.userAgent && window.navigator.userAgent.indexOf('MSIE') > -1,
    j = [' ', ',', '?', '!', ';'];
  function P(e, t) {
    var n = Object.keys(e);
    if (Object.getOwnPropertySymbols) {
        ...
        r(
          ...
          [
              ...
              value: function (t, n, r) {
                ...
                if (k && v && 'string' != typeof v && 'boolean' != typeof v && 'number' != typeof v && ['[object Number]', '[object Function]', '[object RegExp]'].indexOf(b) < 0 && ('string' != typeof O || '[object Array]' !== b)) {
                  if (!n.returnObjects && !this.options.returnObjects) {
                    ...
                    var w = this.options.returnedObjectHandler ? this.options.returnedObjectHandler(y, v, D(D({}, n), {}, { ns: l })) : "key '".concat(c, ' (').concat(this.language, ")' returned an object instead of string.");
                    return i ? ((d.res = w), d) : w;
                  }
                  if (a) {
                    ...
                    for (var P in v)
                      if (Object.prototype.hasOwnProperty.call(v, P)) {
                        ...
                        (S[P] = this.translate(L, D(D({}, n), { joinArrays: !1, ns: l }))), S[P] === L && (S[P] = v[P]);
                      }
                    v = S;
                  }
                } else if (k && 'string' == typeof O && '[object Array]' === b) (v = v.join(O)) && (v = this.extendTranslation(v, t, n, r));
                else {
                  var R = !1,
                    N = !1,
                    C = void 0 !== n.count && 'string' != typeof n.count,
                    E = s.hasDefaultValue(n),
                    F = C ? this.pluralResolver.getSuffix(p, n.count, n) : '',
                    I = n['defaultValue'.concat(F)] || n.defaultValue;
                  !this.isValidLookup(v) && E && ((R = !0), (v = I)), this.isValidLookup(v) || ((N = !0), (v = c));
                  var A = (n.missingKeyNoValueFallbackToKey || this.options.missingKeyNoValueFallbackToKey) && N ? void 0 : v,
                    T = E && I !== v && this.options.updateMissing;
                  if (N || R || T) {
                    if ((this.logger.log(T ? 'updateKey' : 'missingKey', p, f, c, T ? I : v), a)) {
                      var V = this.resolve(c, D(D({}, n), {}, { keySeparator: !1 }));
                    ...
                    var U = [],
                      K = this.languageUtils.getFallbackCodes(this.options.fallbackLng, n.lng || this.language);
                    if ('fallback' === this.options.saveMissingTo && K && K[0]) for (var B = 0; B < K.length; B++) U.push(K[B]);
                    ...
                    var M = function (e, t, r) {
                      var i = E && r !== v ? r : A;
                      o.options.missingKeyHandler ? o.options.missingKeyHandler(e, f, t, i, T, n) : o.backendConnector && o.backendConnector.saveMissing && o.backendConnector.saveMissing(e, f, t, i, T, n), o.emit('missingKey', e, f, t, v);
                    };
                    this.options.saveMissing &&
                      (this.options.saveMissingPlurals && C
                        ? U.forEach(function (e) {
                            o.pluralResolver.getSuffixes(e, n).forEach(function (t) {
                              M([e], c + t, n['defaultValue'.concat(t)] || I);
                            });
                          })
                        : M(U, c, I));
                  }
                  (v = this.extendTranslation(v, t, n, d, r)),
                    N && v === c && this.options.appendNamespaceToMissingKey && (v = ''.concat(f, ':').concat(c)),
                    (N || R) && this.options.parseMissingKeyHandler && (v = 'v1' !== this.options.compatibilityAPI ? this.options.parseMissingKeyHandler(this.options.appendNamespaceToMissingKey ? ''.concat(f, ':').concat(c) : c, R ? v : void 0) : this.options.parseMissingKeyHandler(v));
                }
            ...
            },
            {
              ...
              value: function (e, t, n, r, o) {
                var i = this;
                if (this.i18nFormat && this.i18nFormat.parse) e = this.i18nFormat.parse(e, D(D({}, this.options.interpolation.defaultVariables), n), r.usedLng, r.usedNS, r.usedKey, { resolved: r });
              ...
              if ('string' == typeof e && e.indexOf('-') > -1) {
                ...
                return (
                  this.options.lowerCaseLng
                    ...
                    : 2 === n.length
                    ? ((n[0] = n[0].toLowerCase()), (n[1] = n[1].toUpperCase()), t.indexOf(n[1].toLowerCase()) > -1 && (n[1] = T(n[1].toLowerCase())))
                    : 3 === n.length &&
                      ((n[0] = n[0].toLowerCase()),
            ...
            value: function (e, t) {
              ...
              return (
                'string' == typeof e && e.indexOf('-') > -1
                  ? ('languageOnly' !== this.options.load && i(this.formatLanguageCode(e)), 'languageOnly' !== this.options.load && 'currentOnly' !== this.options.load && i(this.getScriptPartFromCode(e)), 'currentOnly' !== this.options.load && i(this.getLanguagePartFromCode(e)))
      ...
      t(this, e),
        ...
        (this.formats = {
          ...
          currency: G(function (e, t) {
            var n = new Intl.NumberFormat(e, Y(Y({}, t), {}, { style: 'currency' }));
            return function (e) {
              return n.format(e);
            };
          }),
          ...
          value: function (e, t, n) {
            ...
            return e.length
              ? this.readingCalls >= this.maxParallelReads
                ? void this.waitingReads.push({ lng: e, ns: t, fcName: n, tried: o, wait: i, callback: a })
                : (this.readingCalls++,
        ...
        },
        {
          ...
          value: function (e, t, n, r, o) {
            ...
            this.services.utils && this.services.utils.hasLoadedNamespace && !this.services.utils.hasLoadedNamespace(t)
              ...
              : null != n && '' !== n && (this.backend && this.backend.create && this.backend.create(e, t, n, r, null, Z(Z({}, i), {}, { isUpdate: o })), e && e[0] && this.store.addResource(e[0], t, n, r));
          }
        }
      ]),
      i
      ...
      r(u, [
        {
          ...
          value: function () {
            ...
            if (
              ((this.options = oe(oe(oe({}, o), this.options), ne(n))),
              'v1' !== this.options.compatibilityAPI && (this.options.interpolation = oe(oe({}, o.interpolation), this.options.interpolation)),
              ...
              var a;
              this.modules.logger ? g.init(i(this.modules.logger), this.options) : g.init(null, this.options), this.modules.formatter ? (a = this.modules.formatter) : 'undefined' != typeof Intl && (a = Q);
              ...
              (u.logger = g),
                ...
                (u.backendConnector = new te(i(this.modules.backend), u.resourceStore, u, this.options)),
            ...
            if (((this.format = this.options.interpolation.format), r || (r = ae), this.options.fallbackLng && !this.services.languageDetector && !this.options.lng)) {
  ...
  c(se, 'createInstance', function () {
    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
      t = arguments.length > 1 ? arguments[1] : void 0;
    return new se(e, t);
  });
  var ue = se.createInstance();
  return (ue.createInstance = se.createInstance), ue;
});
