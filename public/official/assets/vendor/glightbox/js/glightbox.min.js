              ...
              if (
                ...
                '' == s.title && '' == s.description
                  ...
                  : (d && '' !== s.title ? ((d.id = f), (d.innerHTML = s.title)) : d.parentNode.removeChild(d),
                    u && '' !== s.description ? ((u.id = p), l && n.moreLength > 0 ? ((s.smallDescription = this.slideShortDesc(s.description, n.moreLength, n.moreText)), (u.innerHTML = s.smallDescription), this.descriptionEvents(u, s)) : (u.innerHTML = s.description)) : u.parentNode.removeChild(u),
